...
export default function DataCards({ searchTerm, sortBy, sortOrder }: DataCardsProps) {
        ...
        {patients.map((patient) => (
          <div key={patient.patient_id} className="bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div className="p-6 pt-4">
              <div className="mb-4">
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${getMedicalIssueColor(patient.medical_issue)}`}>
